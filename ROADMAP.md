...
| | |
|---|--|
| **Суть** | Пересмотреть окно выборки, фильтр выбросов, согласование с редкостью (отдельные медианы vs одна общая). Возможно учитывать при расчетах количество лотов на аукционе и из это прогнозировать рост и падение цены (учитывать время суток) |
